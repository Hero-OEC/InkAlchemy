...
import { insertCharacterSchema, type Character, type Project } from "@shared/schema";
import { z } from "zod";
import { ArrowLeft, Save, Users, Crown, Sword, Shield, Zap, Heart, Skull } from "lucide-react";
...
export default function EditCharacter() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: z.infer<typeof formSchema>) => 
      apiRequest("PATCH", `/api/characters/${characterId}`, data),
    onSuccess: () => {
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-brand-600">Update character details and information</p>
          </div>
        </div>
