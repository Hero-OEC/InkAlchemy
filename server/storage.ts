...
export class MemStorage implements IStorage {
    ...
    const defaultCharacters: Character[] = [
      {
        ...
        goals: "Master her magical abilities and protect the realm",
        powerType: "Elemental Magic",
        age: "19",
        race: "Human",
      ...
      },
      {
        ...
        goals: "Guide the next generation of mages",
        powerType: "Ancient Magic",
        age: "150",
        race: "Elf", 
        role: "Mentor",
        imageUrl: null,
      ...
      },
      {
        ...
        goals: "Conquer the realm using dark magic",
  ...
  async createCharacter(insertCharacter: InsertCharacter): Promise<Character> {
    ...
    const character: Character = {
      ...
      type: insertCharacter.type ?? "supporting",
